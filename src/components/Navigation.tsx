...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 py-6 bg-gradient-to-b from-purple-mid/90 via-background/70 to-transparent backdrop-blur-sm border-b border-primary/10">
